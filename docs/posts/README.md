...
每張都有 `lang`（ja 99、ko 21、th 10、vi 10；繁中／簡中／英文／馬來文暫時冇）。
...
加咗 137–140（日本 Web 予約帖 A-01、B-02、B-04，同「アプリ不要」影片 07 秒幀）。
137–139 同時用喺首頁「社交平台」區塊嘅卡面（見 `/_src/social.py`）。
B-01／B-03／B-05 冇加：B-03 日曆年份錯，B-01／B-05 有測試資料。
