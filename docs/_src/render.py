...
for code, path in PATHS.items():
    ...
    s = s.replace('</style>', CSS + POSTS_CSS + '</style>').replace('</head>', alts + '</head>')
...
base = base.replace('</style>', CSS + POSTS_CSS + '</style>').replace('</head>', '<meta name="robots" content="noindex,nofollow">' + alts + '</head>')
